        ...
        <div className="media-body mg-l-20 pos-relative">
          <div>
            ...
            }
            {
             ...
             {
              !!LinkMaterials && <div className="course-docs mg-t-15">
                <h6 className="mg-b-3 tx-bold">Link Materials :</h6>
                <div> <a href={LinkMaterials} target="_blank">View</a></div>
              </div>
            }        
          </div>
            ...
            <div className="action-right">
              {
                ...
                </a> : <button disabled className="btn btn-block btn-disabled btn-sm" data-toggle="tooltip" title="Bạn không thể hủy lớp 60 phút trước khi vào học !!" data-placement="top">
