...
const now = new Date();
const ClassesDetail = ({dataClass,totalResultPage,pageSizePage, selectionDate, monthDate}) => {

	console.log('Total rs: ', totalResultPage);
	...
	console.log("Selection here: ", selectedSection);
