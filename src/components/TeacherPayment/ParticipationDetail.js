...
const now = new Date();
const ParticipationDetail = ({dataClass,totalResultPage,pageSizePage, selectionDate, monthDate}) => {
	...
	console.log("TOTAL RS PAGE TEST: ", totalResultPage);
	console.log("TOTAL RS TEST: ", totalResult);
	...
	useEffect(() => {
		setPageSize(pageSizePage);
		setTotalResult(totalResultPage);
		setSelectedSection(selectionDate);
		setMonth(monthDate);

	},[totalResultPage],[pageSizePage]);
	return (
		<>
