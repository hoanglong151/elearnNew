                                        ...
                                        <tr key={`${index}`}>
                                            ...
                                            <td>
                                                ...
                                                !!ls.FileAudio2 && <div className="mg-b-0">
                                                 ...
                                                 {
                                                !!ls.LinkMaterials && <div className="mg-b-0">
                                                    <span className=" mg-r-5">LinkMaterials:</span>
                                                    <span className="tx-gray-500"> <a href={ls.LinkMaterials} target="_blank">View</a></span>
                                                </div>
                                                }
                                                 {
                                                !!ls.TeacherGuide && <div className="mg-b-0">
                                                    <span className=" mg-r-5">Teacher Guide:</span>
                                                    <span className="tx-gray-500"> <a href={ls.TeacherGuide} target="_blank">Download</a></span>
                                                </div>
                                                }
                                            </td>
